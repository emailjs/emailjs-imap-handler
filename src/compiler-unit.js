...
describe('IMAP Command Compiler', function () {
  ...
  describe('Types', function () {
    ...
    describe('No attributes', function () {
      it('should compile correctly', function () {
        expect(compiler(parsed)).to.equal('* CMD')
      })
    })
    ...
    describe('TEXT', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD Tere tere!')
      })
    })
    ...
    describe('SECTION', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD [ALERT]')
      })
    })
    ...
    describe('ATOM', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD ALERT \\ALERT "NO ALERT"')
      })
    })
    ...
    describe('SEQUENCE', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD *:4,5,6')
      })
    })
    ...
    describe('NIL', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD NIL NIL')
      })
    })
    ...
    describe('No Command', function () {
      it('should compile correctly', function () {
        ...
        expect(compiler(parsed)).to.equal('* 1 EXPUNGE')
      })
    })
    describe('Literal', function () {
      it('shoud return as text', function () {
        ...
        expect(compiler(parsed)).to.equal('* CMD {10}\r\nTere tere! "Vana kere"')
      })
      ...
      it('should compile correctly without tag and command', function () {
        ...
        expect(compiler(parsed, true)).to.deep.equal(['{10}\r\n', 'Tere tere! {9}\r\n', 'Vana kere'])
      })
      ...
      it('shoud return byte length', function () {
        ...
        expect(compiler(parsed, false, true)).to.equal('* CMD "(* 10B literal *)" "Vana kere"')
      })
    })
  })
})
